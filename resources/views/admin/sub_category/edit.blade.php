                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" value="{{ $subCategory->name }}" id="name" class="form-control" placeholder="Sub Category Name">	
                            <p></p>
                        </div>
                    </div>
                    <div class="col-md-6">
...
@section('customJs')
    <script>
         $("#subCategoryForm").submit(function(event){
            ...
            $.ajax({
                url:'{{ route("sub-categories.index", $subCategory->id) }}',
                type:'post',
